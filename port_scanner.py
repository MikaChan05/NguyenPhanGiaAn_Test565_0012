...
COMMON_PARTS = [21,22,23,25,53,80,110,143,443,44,3389]
def scan_common_parts(target_domain, timeout = 2):
    open_ports = []
    target_ip = socket.gethostbyname(target_domain)
    for port in COMMON_PARTS:
...
def main():
    ...
    open_ports = scan_common_parts(target_domain)
    if open_ports:
